...
@section('content')
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src="{{ $serie['poster_path'] }}" alt="parasite" class="w-64 lg:w-96">
            </div>
            <div class="md:ml-24">
                <div class="relative">
                    <h2 class="text-4xl mt-4 md:mt-0 font-semibold">{{ $serie['name'] }}</h2>
                    <livewire:favorite-button :tmdbId="$serie['id']" type='serie' />
                </div>
                                    ...
                                    <div class="bg-gray-900 rounded">
                                        ...
                                        <div class="modal-body px-8 py-8">
                                            <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                                <iframe class="responsive-iframe absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/{{ $serie['videos']['results'][0]['key'] }}" style="border:0;" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
